            ...
            <div className="App_Page2 max-[701px]:hidden relative flex flex-col grow w-full overflow-hidden bg-white  h-screen text-white">
                ...
                <div className='w-full subPage2 flex justify-between  items-end text-white '>
                    ...
                    <div className='flex items-end absolute w-[35%] -mb-[0%] '>
                        <div><img className='-ml-[18%]  w-[100%] -mb-[0%] mr-[0%]' src={COLUMNLEFT} alt="background" />  </div>
                        <div><img className='w-[100%] mb-[70%] ml-[70%]' src={SMALL} alt="background" /></div>
                        <div><img className='w-[100%] mb-[30%]  -ml-[100%]' src={MEDIUM} alt="background" /></div>
                    </div>
                    ...
                    <div className='flex -ml-[20%] absolute w-[120%]'>
                        <div className=''><img className='w-[100%] -mb-[0%] -mt-[9%] ml-[119%] ' src={COLUMN} alt="background" /></div>
                        <div><img className='w-[100%] -mb-[0%]  mt-[40%] ml-[340%]' src={MEDIUM} alt="background" /></div>
                        <div><img className='w-[100%] mt-[8%] -ml-[40%] ' src={COLUMNCENTER} alt="background" />  </div>
                    </div>

                    <div className='flex w-[35%] ml-[30%] absolute'>
                        <div><img className='w-[100%] -mt-[124%] ml-[130%]' src={LARGE} alt="background" /></div>
                        <div><img className='w-[100%]  -mt-[62%] -ml-[48%]' src={MEDIUM} alt="background" /></div>
                        <div><img className='w-[100%] -mb-[0%] -ml-[50%]' src={MEDIUMSHORT} alt="background" />  </div>
                    </div>
                </div>
            ...
            <div className="App_Page2 min-[701px]:hidden relative flex flex-col grow w-full overflow-hidden bg-white  h-screen text-white">
                ...
                <div className='w-full subPage2Mobile flex justify-end  text-white '>
                    <div className='flex absolute   w-[80%] -ml-[10%] left-0 bottom-0'>
                        <div><img className='w-[100%] ml-[70%] mt-[60%]' src={LARGE} alt="background" /></div>
                        <div><img className='w-[100%] -ml-[70%]' src={COLUMNLEFT} alt="background" /></div>
                    </div>

                    <div className='flex  items-end  w-[65%]'>
                        <div><img className=' w-[100%] ml-[30%] mb-[40%]' src={MEDIUM} alt="background" />  </div>
                        <div><img className='w-[100%] ' src={COLUMNLEFT} alt="background" /></div>
                    </div>
                </div>
