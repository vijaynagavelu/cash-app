        ...
        <main>
            <div className="App_Page3 max-[701px]:hidden  relative flex w-full overflow-hidden bg-[#00d54b]  h-screen text-white">
                ...
                <div className='w-full flex grow justify-between  text-white '>
                    ...
                    <div className='flex flex-col  justify-between items-center abslute w-[50%]'>
                        <div><img className='w-[100%] ' src={BANKINGHOLE} alt="background" /></div>
                        <div><img className='w-[55%] ml-[13%] -mt-[60%]' src={BANKINGCOLUMN} alt="background" /></div>
                        <div><img className='w-[55%] lg:-ml-[20%]  mb-[70%] sm:-ml-[5%]' src={BANKINGSTAIRS2} alt="background" />  </div>
                    </div>

                    <div className='flex flex-col justify-end items-center absoute w-[50%]  '>
                        <div><img className='w-[75%] -ml-[5%] -mb-[45%] mt-[0%]' src={BANKINGTRACK1} alt="background" /></div>
                        ...
                        <div><img className='w-[105%] ml-[35%] -mb-[20%]' src={BANKINGPHONE} alt="background" />  </div>
                        <div><img className='w-[75%] -ml-[50%] -mb-[20%]' src={BANKINGRAMP2} alt="background" /></div>
                        <div><img className='w-[50%] ml-[30%] mb-[0%]' src={BANKINGTUBE} alt="background" /></div>
                    </div>

                    <div className='flex flex-col justify-between items-end abslute w-[50%]'>
                        <div><img className='w-[75%] ml-[20%] mt-[55%]' src={BANKINGRAMP1} alt="background" /></div>
                        <div><img className='w-[65%] ml-[50%] -mb-[10%]' src={BANKINGCUBES} alt="background" /></div>
                        <div><img className='w-[100%] ml-[10%]' src={BANKINGHOLEDOWN} alt="background" />  </div>
                    </div>

                    <div className='flex flex-col justify-between items-center w-[50%]  abslute'>
                        <div><img className='w-[75%] -ml-[30%] mt-[2%]' src={BANKINGTRACK2} alt="background" /></div>
                        <div><img className='w-[55%] ml-[10%]' src={BANKINGSTAIRS1} alt="background" /></div>
                        <div><img className='w-[55%] ml-[20%] mb-[25%]' src={BANKINGMONSTER} alt="background" />  </div>
                    </div>
            ...
            <div className="App_Page3 min-[701px]:hidden  relative flex w-full overflow-hidden bg-[#00d54b]  h-screen text-white">
                ...
                <div className='w-full flex grow justify-between  text-white '>
                    ...
                    <div className='flex flex-col  justify-between items-center abslute w-[50%]'>
                        <div><img className='w-[100%]' src={BANKINGHOLE} alt="background" /></div>
                        <div><img className='w-[80%]' src={BANKINGCOLUMN} alt="background" /></div>
                        <div><img className='w-[75%] pl-4' src={BANKINGSTAIRS2} alt="background" />  </div>
                    </div>
                    ...
                    <div className='flex flex-col justify-between items-center absoute w-[50%]  '>
                        ...
                        <div><img className='w-[100%] ' src={BANKINGPHONE} alt="background" />  </div>
                        <div><img className='w-[60%] ' src={BANKINGTUBE} alt="background" /></div>
                    </div>

                    <div className='flex flex-col relative justify-between items-center pr-4 w-[40%]  abslute'>
                        <div><img className='w-[100%] absolute right-0 mr-4' src={BANKINGTRACK2} alt="background" /></div>
                        <div><img className='w-[75%] ' src={BANKINGSTAIRS1} alt="background" /></div>
                        <div><img className='w-[100%] pb-12' src={BANKINGMONSTER} alt="background" />  </div>
                    </div>
